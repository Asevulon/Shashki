...
// Shashki.cpp: определяет поведение классов для приложения.
//
...
// Создание CShashkiApp

CShashkiApp::CShashkiApp()
{
...
// Единственный объект CShashkiApp

CShashkiApp theApp;


// Инициализация CShashkiApp

BOOL CShashkiApp::InitInstance()
{
